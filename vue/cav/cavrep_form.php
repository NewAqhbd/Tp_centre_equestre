...
<?php 
if(isset($new)){?>
    <div id="dialog_modify" title="Ajouter ce cavalier ?"></div>
<?php }
else{ ?>
...
<?php 
if(isset($new)){?>
    <div id="dialog_cancel" title="Annuler l'ajout du cavalier ?"></div>
<?php } 
else{ ?>
...
<div class="container">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="row justify-content-md-center">
            ...
            <div class="form-group col">
                <label for="iPrenomCavalier">Prénom*</label>
        ...
        <div class="row">
            ...
            <div class="form-group col">
                ...
                <input type="hidden" name="photoName" value="<?= isset($infosaved) ? $infosaved["photoName"] :  "choose-image.png" ?>">
